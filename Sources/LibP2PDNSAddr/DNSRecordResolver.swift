...
public typealias TXTResolverResult = Result<TXTResult, SRVResolverError>
...
class DNSRecordResolver {
    ...
    func resolve(query: String, completion: TXTResolverCompletion? = nil) {
        ...
        let result = DNSServiceQueryRecord(&self.serviceRef, kDNSServiceFlagsReturnIntermediates, UInt32(0), namec,  UInt16(kDNSServiceType_TXT),  UInt16(kDNSServiceClass_IN), queryCallback, DNSRecordResolver.bridge(self))
